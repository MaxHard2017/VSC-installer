...
git_install() {
    ...
    # as e-mail stands as a critical personal information i.e. sicret-like
    # read e-mail from file to user_email variable

    echo "  reading e-mail from $SRC_GITMAIL"
    echo "  for more info: https://github.com/settings/emails"
    file=$SRC_GITMAIL
    if [ -e $file ]; then 
